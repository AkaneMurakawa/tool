 ...
 * 切面接口
 *
 * @see cn.hutool.aop.aspects.Aspect
 */
public interface Aspect {
    ...
    /**
     * 目标方法执行后的操作<br>
     * 如果 target.method 抛出异常且 {@link cn.hutool.aop.aspects.Aspect#afterException} 返回true,则不会执行此操作<br>
     * 如果 {@link cn.hutool.aop.aspects.Aspect#afterException} 返回false,则无论target.method是否抛出异常，均会执行此操作<br>
     *
     * @param target    目标对象
     * @param method    目标方法
     * @param args      参数
